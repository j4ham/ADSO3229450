...
function fnCalcular(){
    ...
    fnSalidaContenedorDivDivisionR(numero1, numero2);
...
function fnSalidaContenedorDivDivisionR(num1, num2) {

    const resultadoResiduo = fnResiduoLlamada(num1, num2);

    console.log(`El residuo es: ${num1} % ${num2} = ${resultadoResiduo}`);

    document.querySelector(".divSalidaResiduo").textContent =
    `Al sacar el residuo: ${num1} % ${num2} = ${resultadoResiduo}`;
}

function fnResiduoLlamada(num1, num2) {
